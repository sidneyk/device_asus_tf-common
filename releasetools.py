...
def IncrementalOTA_InstallEnd(info):
    ...
    try:
        ...
        write = True
    if write:
        print "TF common: boot blob changed"
        WriteBlob(info, target)
    else:
        print "TF common: boot blob unchanged, skipping"
